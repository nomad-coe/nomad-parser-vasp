...
class VASPParser(ParserInterface):
    ...
    def __init__(self, main_file, metainfo_to_keep=None, backend=None, default_units=None, metainfo_units=None, debug=True, log_level=logging.ERROR, store=True):
        super(VASPParser, self).__init__(main_file, metainfo_to_keep, backend, default_units, metainfo_units, debug, log_level, store)
    ...
    def setup_version(self):
        ...
        self.main_parser = VASPMainParser(self.parser_context.main_file, self.parser_context)
